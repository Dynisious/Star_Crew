...
Public Class Battery
    ...
    Public Overrides Sub Update()
        Power = Power + Influx 'Adds power to the stored power inside the Station for use
        ...
        Else 'The Station is controlled by a Player
            If Parent.Helm.Target IsNot Nothing Then 'There is an active target
                If Parent.Helm.Target.Dead = True Then 'The target is dead and so must be untargeted
                    Parent.Helm.Target = Nothing 'Clear the target
                End If
            End If
        End If
    End Sub
