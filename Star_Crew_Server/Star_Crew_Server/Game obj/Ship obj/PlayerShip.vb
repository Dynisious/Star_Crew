Public Class PlayerShip
    ...
    Public ReadOnly Property Primary As Weapon 'A Weapon object for the Ship
        ...
        End Get
    End Property
    Public target As Integer = -1 'An Integer indicating the closest target to the Player
    ...
    Public Overrides Sub Update()
        MyBase.Update()
        If Primary IsNot Nothing Then Primary.Update() 'Update Primary

        '-----Targeting-----
        target = -1 'Clear target
        ...
        For i As Integer = 0 To obj(0).Length - 1 'Loop through all the indexes
            ...
            If tar.Allegiance <> Allegiance Then 'This is the target to select
                target = tar.CombatIndex 'Get the target object for the Ship
